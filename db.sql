...
USE sms;
-- Table: admin (for admin credentials)
CREATE TABLE admin (
...
CREATE TABLE event_fixtures (
    ...
    participant1 VARCHAR(255) NOT NULL,  -- Can be team_id (for groups) or student_rollnum (for individuals)
    participant2 VARCHAR(255) NOT NULL,  -- Can be team_id (for groups) or student_rollnum (for individuals)
    round INT NOT NULL,   -- Round 1, 2, ..., Final
...
-- Table: group_event_registrations
...
CREATE TABLE bmi (
    ...
    name VARCHAR(100) NOT NULL,
    branch VARCHAR(100) NOT NULL,  -- Course Name from courses table
...
CREATE TABLE event_results (
    id INT AUTO_INCREMENT PRIMARY KEY,
    event_name VARCHAR(255) NOT NULL,  -- Storing event name directly
