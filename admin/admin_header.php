...
// Logout functionality (without header redirect)
if (isset($_POST['logout'])) {
    session_destroy();
    // No header redirect here; we'll rely on the link instead
}
?>
...
<body>
    <header class="top-header">
        <div class="header-container">
            ...
            <nav class="header-nav">
                <a href="/kl/admin/admin_dashboard.php" class="nav-link">
                    <i class="fas fa-home"></i>
                    Dashboard
                </a>
                <a href="/kl/admin/admin_calender.php" class="nav-link">
                    <i class="fas fa-calendar"></i>
                    Calender
                </a>
                <a href="/kl/admin/view_results.php" class="nav-link">
                    <i class="fas fa-trophy"></i>
                    Achievements
                </a>
                <a href="/kl/admin/view_bill.php" class="nav-link">
                    <i class="fas fa-file-invoice-dollar"></i>
                    Bills
                </a>
            </nav>
            <div class="header-actions">
                <!-- Replaced form and button with a direct link -->
                <a href="/kl/login.php" class="logout-btn" onclick="destroySession()">
    ...
    <!-- JavaScript to handle session destruction on client side -->
    <script>
        function destroySession() {
            // Optional: You can use fetch to call a logout script if needed
            fetch('/kl/logout.php', { method: 'POST' });
        }
    </script>
</body>
</html>